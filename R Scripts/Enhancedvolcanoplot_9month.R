...
#import data
library(readr)
data <- read.csv("Final_9monthCSvsControl_differential_expression_allresults_forvolcano.csv")
head(data)
library(ggplot2)
...
plot1 <- EnhancedVolcano(data,
                ...
                x = 'log2FoldChange',
                y = 'padj',
                title = '9 months CS-exposed vs Air-exposed Mouse Lungs',
...
# Save the plot
ggsave("9monthCSvsAir.png", plot = plot1, units = "in", width = 15, height = 10, dpi = 300)